    ...
    >
      ...
      <motion.div variants={staggerItem}>
        <Button
          ...
          className="rounded-sm cursor-pointer text-xs sm:text-sm px-4 sm:px-6 md:px-8 py-2.5 sm:py-3 md:py-6 font-bold mt-3 sm:mt-4 md:mt-20 w-full sm:w-auto"
        >
          {item.buttonText}
        </Button>
      </motion.div>
    ...
    <div className="w-screen h-screen flex justify-center items-center relative">
      ...
      >
        ...
        <CarouselPrevious
          ...
          disabled={false}
          className="size-15 md:size-16 bg-[#EA9320]/50 hover:bg-[#EA9320] opacity-20 hover:opacity-100 text-white hover:text-white rounded-full absolute top-1/2 left-2 md:left-32 -translate-y-1/2 cursor-pointer z-10 hidden md:flex"
        />
        <CarouselNext
          icon={<ArrowRight className="size-4 md:size-6" />}
          disabled={false}
          className="size-15 md:size-16 bg-[#EA9320]/50 hover:bg-[#EA9320] opacity-20 hover:opacity-100 text-white hover:text-white rounded-full absolute top-1/2 right-2 md:right-32 -translate-y-1/2 cursor-pointer z-10 hidden md:flex"
        />
      </Carousel>
    </div>
  );
